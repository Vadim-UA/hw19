(() => {
  ...
  function le({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c() {
      ...
      if ("bullets" === t.type) {
        ...
        n.html(r), (e.pagination.bullets = n.find(ae(t.bulletClass)));
      }
      "fraction" === t.type &&
        ((r = t.renderFraction
    ...
    oe(),
      document.querySelector(".slider-block__slider") &&
        new re(".slider-block__slider", {
          ...
          speed: 800,
          loop: !0,
          pagination: { el: ".navigation-slider", clickable: !0 },
          on: {},
        });
  });
  e.watcher = new (class {
  ...
  setTimeout(() => {
    ...
    document.querySelectorAll(".body-acordeon__trigger").forEach((e) =>
